...
impl SimStep {
    /// Build a global step by merging multiple local steps while preserving
    /// each workfront's local element order.
    pub fn from_local_steps(local_steps: Vec<LocalStep>) -> Self {
